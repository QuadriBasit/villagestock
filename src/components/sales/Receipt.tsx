...
const Receipt = forwardRef<HTMLDivElement, ReceiptProps>(
  ({ sale, shop, overrides }, ref) => {
    ...
    const timeStr = saleDate.toLocaleTimeString("en-NG", {
      hour: "2-digit",
      minute: "2-digit",
    });
    const showAppleDetails =
      isAppleDevice(sale.item_brand, sale.item_category) && sale.device_details;
    const itemName =
      overrides?.item_name !== undefined ? overrides.item_name : sale.item_name;
    const itemBrand =
      overrides?.item_brand !== undefined
        ? overrides.item_brand
        : sale.item_brand;
    const customerName =
      overrides?.customer_name !== undefined
        ...
        : sale.customer_name;
    const customerPhone =
      overrides?.customer_phone !== undefined
    ...
    const tradeInItemName =
      overrides?.trade_in_item_name !== undefined
        ? overrides.trade_in_item_name
        : sale.trade_in_item_name;
    const tradeInItemBrand =
      overrides?.trade_in_item_brand !== undefined
        ? overrides.trade_in_item_brand
        : sale.trade_in_item_brand;
    const headerColor =
      overrides?.header_color || shop.receipt_theme?.header_color || RC.primary;
    const accentColor =
      overrides?.accent_color || shop.receipt_theme?.accent_color || RC.primary;
    const textColor =
    ...
    const borderColor =
      textColor === RC.dark ? RC.border : withAlpha(textColor, 0.18);
      ...
      >
        ...
        {showAppleDetails && (
          <div style={{ ...sectionDivider, paddingTop: 16, paddingBottom: 16 }}>
            ...
            {"battery_health" in sale.device_details! &&
              sale.device_details.battery_health != null && (
                <Row
                  label="Battery Health"
                  value={`${sale.device_details.battery_health}%`}
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
            {"battery_cycle_count" in sale.device_details! &&
              sale.device_details.battery_cycle_count != null && (
                <Row
                  label="Cycle Count"
                  value={String(sale.device_details.battery_cycle_count)}
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
            {"icloud_lock_status" in sale.device_details! &&
              sale.device_details.icloud_lock_status && (
                <Row
                  label="iCloud Status"
            ...
            {"important_battery_message" in sale.device_details! &&
              sale.device_details.important_battery_message && (
                <Row
                  label="Battery disclosure"
                  value="Important Battery Message / Unknown Part"
                  bold
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
            {"important_display_message" in sale.device_details! &&
              sale.device_details.important_display_message && (
                <Row
                  label="Display disclosure"
                  value="Important Display Message / Unknown Part"
                  bold
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
            ...
            {isAppleMobileDevice(
              sale.item_brand,
              sale.item_category as Category,
            ) &&
              sale.device_details &&
              appleMobileShowsServicedBattery(
                sale.device_details as AppleMobileDeviceDetails,
              ) && (
                <Row
                  label="Battery service"
                  value={
                    typeof (sale.device_details as AppleMobileDeviceDetails)
            ...
            {"mdm_ibm" in sale.device_details! &&
              sale.device_details.mdm_ibm && (
                <Row
                  label="MDM"
                  value="IBM (bypass) flagged"
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
            {"mdm_idm" in sale.device_details! &&
              sale.device_details.mdm_idm && (
                <Row
                  label="MDM"
                  value="IDM flagged"
                  textColor={textColor}
            ...
            {"mdm_icm" in sale.device_details! &&
              sale.device_details.mdm_icm && (
                <Row
                  label="MDM"
                  value="ICM (managed) flagged"
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
            ...
            {"biometric_status" in sale.device_details! &&
              sale.device_details.biometric_status && (
                <Row
                  ...
                  value={readableValue(sale.device_details.biometric_status)}
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
            {"storage" in sale.device_details! &&
              sale.device_details.storage && (
                <Row
                  label="Storage"
                  value={sale.device_details.storage}
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
            {"color" in sale.device_details! && sale.device_details.color && (
              <Row
                label="Color"
                value={sale.device_details.color}
                textColor={textColor}
                mutedColor={mutedColor}
              />
            )}
            ...
            {"chip" in sale.device_details! && sale.device_details.chip && (
              <Row
                label="Chip"
                value={sale.device_details.chip}
                textColor={textColor}
                mutedColor={mutedColor}
              />
            )}
            {"screen_size" in sale.device_details! &&
              sale.device_details.screen_size && (
                <Row
                  label="Screen Size"
                  value={sale.device_details.screen_size}
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
            {"keyboard_status" in sale.device_details! &&
              sale.device_details.keyboard_status && (
                <Row
                  label="Keyboard"
                  value={readableValue(sale.device_details.keyboard_status)}
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
            {"screen_condition" in sale.device_details! &&
              sale.device_details.screen_condition && (
                <Row
                  label="Screen"
                  value={readableValue(sale.device_details.screen_condition)}
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
          ...
          {sale.sale_type === "swap" ? (
            ...
            <>
              ...
              {sale.quantity_sold > 1 && (
                <Row
                  label="Qty"
                  value={String(sale.quantity_sold)}
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
        ...
        <div style={{ ...sectionDivider, paddingTop: 16, paddingBottom: 16 }}>
          ...
          <Row
            ...
            value={sale.payment_status === "credit" ? "Credit" : "Paid"}
            textColor={textColor}
            mutedColor={mutedColor}
          />
          {sale.payment_method && (
          ...
          {sale.payment_status === "credit" && (
            <>
              ...
              {sale.due_date && (
                <Row
                  label="Due Date"
                  value={new Date(sale.due_date).toLocaleDateString("en-NG")}
                  textColor={textColor}
                  mutedColor={mutedColor}
                />
              )}
        ...
        <div style={{ ...sectionDivider, paddingTop: 16, paddingBottom: 16 }}>
          ...
          >
            ...
            >
              {formatCurrency(
                sale.payment_status === "credit" ? amountPaid : salePrice,
              )}
            </span>
          </div>
        </div>
...
function Row({
  ...
  return (
    ...
    >
      <span style={{ fontSize: 12, color: mutedColor, flexShrink: 0 }}>
        {label}
      </span>
      <span
        style={{
