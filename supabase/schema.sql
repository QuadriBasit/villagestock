-- VillageStock — core schema (inventory, sales, credits, repairs, returns, profiles)
--
-- For a **complete** database in one step (includes `business_profiles`, admin RPC, etc.),
-- use **`supabase/FRESH_START.sql`** (or migration `20260115000000_villagestock_fresh_start.sql`)
-- after you reset or create a project.
--
-- This file alone is safe to re-run for retail tables; enums use duplicate_object guards.
